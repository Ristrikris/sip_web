...
@section('konten')
    <section class="content-header">
        <h4><b>Daftar Jadwal Perwalian Mandiri</b></h4>
    </section>
    <br> 
    <div>
        <div class="col-md-8">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <a class="btn btn-primary" href="/sip/tambahPerwalianMandiri" role="button">Tambah [+]</a><br><br>
                    <table class="table table-striped table-hover table-responsive">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{$j->keterangan}}</td>
                                <td>
                                <a href="/sip/editPerwalianMandiri/{{$j->id_jadwal}}" class="btn btn-primary">Edit</a>
                                </td>
                                <!-- <td>
                                <a href="/sip/delete_perwalian/{{$j->id_jadwal}}" class="btn btn-danger">Delete</a>
                                </td> -->
                                <td>
                                <a href="/sip/lihatPesertaMandiri/{{$j->id_jadwal}}" class="btn btn-info">Lihat Mahasiswa</a>
                                </td>
                                <td>
                                <a href="/sip/reportMandiri/{{$j->id_jadwal}}" class="btn btn-primary">Report</a>
                                </td>
                                <td>
                                <a href="/sip/selesaiMandiri/{{$j->id_jadwal}}" class="btn btn-warning">Perwalian Selesai</a>
                                </td>
                            </tr>
                        </tbody>
                        @endforeach
                ...
                <div class="box-header with-border">
                <h4><b>Daftar Jadwal Perwalian Mandiri Selesai</b></h4>
                    <table class="table table-striped table-hover table-responsive">
                        <thead class="thead-dark">
                            <tr align="center">
                                <th scope="col"><center>No.</th>                            
